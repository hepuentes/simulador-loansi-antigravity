...
# ROUTE MIGRATED TO app/routes/simulador.py
...
# ROUTE MIGRATED TO app/routes/auth.py
...
# ROUTE MIGRATED TO app/routes/main.py
# @app.route("/dashboard")
# REMOVED TO PREVENT CONFLICTS
...
# ROUTE MIGRATED TO app/routes/admin_routes.py
# @app.route("/admin/capacidad/guardar", methods=["POST"])
# REMOVED TO PREVENT CONFLICTS
# ROUTE MIGRATED TO app/routes/admin_routes.py
# @app.route("/admin_panel_migrated")
# REMOVED TO PREVENT CONFLICTS
